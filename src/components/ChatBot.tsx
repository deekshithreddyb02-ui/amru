...
const ChatBot = () => {
  ...
  const { offices } = useOfficeContacts();
    ...
    <>
      ...
      <div className="fixed bottom-24 right-6 z-50">
                  ...
                  <div key={i} className="p-3 space-y-1.5">
                    ...
                    <div className="flex gap-2">
                      <a
                        ...
                        className="flex-1 flex items-center gap-1.5 text-xs bg-[#25D366]/10 text-[#25D366] rounded-lg px-2.5 py-2 hover:bg-[#25D366]/20 transition-colors font-medium"
                      >
                      ...
                      <a
                        ...
                        className="flex-1 flex items-center gap-1.5 text-xs bg-primary/10 text-primary rounded-lg px-2.5 py-2 hover:bg-primary/20 transition-colors font-medium"
                      >
        ...
        <motion.button
          ...
          className="w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg flex items-center justify-center hover:opacity-90 transition-opacity"
