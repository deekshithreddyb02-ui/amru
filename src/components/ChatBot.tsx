              ...
              <div className="max-h-64 overflow-y-auto divide-y divide-border">
                {offices.map((office, i) => <div key={i} className="p-3 space-y-1.5">
                    ...
                    <div className="flex gap-2">
                      <a href={`https://wa.me/${office.whatsapp}`} target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center gap-1.5 text-xs bg-[#25D366]/10 text-[#25D366] rounded-lg px-2.5 py-2 hover:bg-[#25D366]/20 transition-colors font-medium">
