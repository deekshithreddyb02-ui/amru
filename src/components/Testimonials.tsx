...
const testimonials = [
  ...
  {
    text: "If you are in need of ground water survey, surely would recommend them.",
    name: "Kalpana Pillai",
    organization: "",
  },
  {
    text: "Got rainwater harvesting done for my society. Highly effective results. Literally the best.",
